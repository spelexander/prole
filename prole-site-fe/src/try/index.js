...
function Try() {
    ...
    console.log('rendering Try')
    return (
        <>
            <Typography style={{fontSize: '15', fontWeight: 100, textAlign: 'center', marginLeft: '10px'}} variant="body">
                Enter a company domain below (e.g. example.com)
                <br/>
                <br/>
            </Typography>
            <InlineEdit width='100%' startEdit initialValue={url} onChanged={setUrl}/>
            <Divider style={style}/>
